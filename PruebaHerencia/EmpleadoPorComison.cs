...
{
    public class EmpleadoPorComison
    {
        ...
        public EmpleadoPorComison(string nombre, string apellido, string seguroSocial, decimal tarifa, 
            decimal venta) { 
        ...
        public decimal TarifaComision { get { return tarifaComision ; } 
            set {
                tarifaComision =  (value <= 0 && value < 1) ? value : 0; } }
        public decimal VentasBrutas { get { return ventasBrutas; } 
            set {
